...
class Constructor{
    ...
    float volume;
    float area;
    Constructor(float radius,float height){
        this.radius=radius;
        this.height=height;
    }
    void VolumeCylinder(){
...
//        Constructor cy=new Constructor(r,h);//We can also take value from user in constructor
        Constructor cy=new Constructor(5,76);
        cy.getCylinder();
        cy.VolumeCylinder();
        cy.getVolume();
        cy.AreaCylinder();
